...
In order to implement the AlphaBeta algorithm, we used the same functions as the Minimax algorithm, but added two parameters to the functions, alpha and beta. The alpha and beta parameters are used to prune the search tree, and are initialized as -9999 and 9999 respectively. The alpha and beta parameters are updated in the minimizer function, and the maximizer function, as shown in the code below:
...
\begin{table}[ht]
  ...
  \begin{tabular}{||c||c|c|c|c||}
    ...
    Depth & 2 & 3 & 4 & 5 \\
    \hline\hline
    Average &  -121.5 &  413.6 &  635.85 & 0 \\
    \hline\hline
    Best & 1001 & 1604 & 1701 & 0 \\
    \hline\hline
    Win Rate & 1/20 (0.05) & 9/20 (0.45) & 11/20 (0.55) & 0 \\
    \hline
  \end{tabular}
  \caption{Minimax test results}
  \end{center}
